...
<head>
    ...
    <title>Edit Komponen Masakan - Tirta Catering</title>
    ...
    <div class="container">
        ...
        <form action="{{ route('admin.komponen-masakan.update', $komponenMasakan->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="satuan_dasar" name="satuan_dasar" value="{{ old('satuan_dasar', $komponenMasakan->satuan_dasar) }}">
                @error('satuan_dasar')
                    <span class="error-message">{{ $message }}</span>
                @enderror
            </div>
